...
import UpdateSharedBooksData from './update_shared_books_data';
  ...
  describe('updating the shared data file when the library has items in it', () => {
    it('adds the books to the data file', async () => {
      ...
      expect(getMock('S3.putObject')).toHaveBeenCalledWith({
        ...
        Body: Buffer.from(`{"books":[{"author":"V. Anton Spraul","title":"Think Like a Programmer","files":[{"type":"epub","location":"1292d5d1-68e8-4938-9ec7-23aa3681f6eb","file":null}]},{"author":"Norman Matloff","title":"Art of R Programming","files":[{"type":"epub","location":"1292d5d1-68e8-4938-9ec7-23aa3681f6eb","file":null}]},{"author":"Orson Scott Card","title":"Children of the Mind","files":[{"type":"epub","location":"1292d5d1-68e8-4938-9ec7-23aa3681f6eb","file":null}]},{"author":"Orson Scott Card","title":"Seventh Son","files":[{"type":"epub","location":"1292d5d1-68e8-4938-9ec7-23aa3681f6eb","file":null}]}],"lastUpdated":${Math.round(Date.now() / 1000)}}`),
      }, expect.any(Function));
    });
  });
  ...
  describe('updating the shared data file when the library is empty of books', () => {
    it('updates the books data with an empty array', async () => {
      ...
      expect(getMock('S3.putObject')).toHaveBeenCalledWith({
        Bucket: 'the-infinite-library-test-data',
        Key: 'public/data/books.json',
        Body: Buffer.from(`{"books":[],"lastUpdated":${Math.round(Date.now() / 1000)}}`),
      }, expect.any(Function));
    });
  });
});
